    ...
    <div style="padding-top:8px">
      <div style="background:white;border-radius:16px;padding:20px;border:1px solid #e5e7eb;margin-bottom:16px">
        <div style="display:flex;align-items:center;gap:12px;margin-bottom:18px">
          <div style="width:48px;height:48px;background:#EFF6FF;border-radius:14px;display:flex;align-items:center;justify-content:center;flex-shrink:0">
            <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#185FA5" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="23 7 16 12 23 17 23 7"/><rect x="1" y="5" width="15" height="14" rx="2"/></svg>
          </div>
          <div>
            <div style="font-size:16px;font-weight:700;color:#1a1a1a">Video muloqot</div>
            <div style="font-size:13px;color:#888">Jitsi Meet — bepul, ro'yxatdan o'tishsiz</div>
          </div>
        </div>
        <label style="font-size:13px;font-weight:600;color:#555;display:block;margin-bottom:6px">Xona nomi</label>
        <input class="inp" id="videoRoomInp" value="${defaultRoom}" placeholder="xona-nomi" style="margin-bottom:14px;border-radius:10px">
        <button onclick="startVideoMeeting()" style="width:100%;padding:14px;background:#185FA5;color:#fff;border:none;border-radius:12px;font-size:15px;font-weight:700;cursor:pointer;font-family:inherit">
          &#128249; Muloqotni boshlash
        </button>
        <div style="margin-top:12px;padding:12px;background:#f8faff;border-radius:10px;border:1px solid #dbeafe">
      ...
      <div id="jitsiWrap" style="display:none">
        <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:10px">
          <div style="font-size:14px;font-weight:700;color:#1a1a1a">&#128308; Muloqot davom etmoqda</div>
